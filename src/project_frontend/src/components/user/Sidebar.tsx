  ...
  return (
    <aside className="w-50 h-screen flex flex-col justify-start fixed top-0 left-0 bg-[#FFFFFF] text-white">
      ...
      <Link to="/create-campaign">
        <div
          className={`flex items-center justify-start p-3 mr-2 h-10 rounded-tr-lg rounded-br-lg cursor-pointer text-[#2D2D2D] hover:bg-[#2D2D2D] hover:text-white hover:duration-300 hover:ease-linear focus:bg-[#2D2D2D] mb-2 ${activeLink === "/create-campaign" ? "bg-[#2D2D2D] text-white" : ""
            }`}
