  ...
  return (
    <div>
      ...
      <div className="mt-[60px] flex lg:flex-row flex-col gap-5">
        <div className="flex-[2] flex flex-col gap-[40px] bg-[#1c1c24] rounded-[10px] p-10">
          <div>
        ...
        {usertype === "donor" &&
          <div className="flex-1">
            <h4 className="font-epilogue font-semibold text-[18px] text-white uppercase flex flex-col p-4 bg-[#1c1c24] rounded-[10px]">
              Fund
            </h4>
